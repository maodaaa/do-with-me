...
Future<void> createReminderNotification(
    String task, String date, String time, String reminder) async {
  ...
  List parts = [
    reminder.substring(0, idx).trim(),
    reminder.substring(idx + 1).trim()
  ];
  if (parts[0] == '1') {
...
Future<void> updateReminderNotification(String date, String time,
    String taskNew, String dateNew, String timeNew, String reminder) async {
  String dateTime = '$date $time';
  DateTime dateFormattedNew =
      DateFormat('dd MMMM yyyy').parse(dateNew).toLocal();
